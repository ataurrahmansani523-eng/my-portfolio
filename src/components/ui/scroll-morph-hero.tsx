    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-zinc-950 flex flex-col items-center justify-center p-2 border border-[#C8A24A]/40 text-center"
                    style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-[#C8A24A] uppercase tracking-widest mb-0.5">Asset</p>
                        <p className="text-[11px] font-medium text-white">#{index + 1}</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
...
export default function IntroAnimation() {
    ...
    // --- Intro Sequence (Triggers when user reaches this section) ---
    useEffect(() => {
        if (!isInView) return;

        setIntroPhase("scatter");
        const timer1 = setTimeout(() => setIntroPhase("line"), 500);
        const timer2 = setTimeout(() => setIntroPhase("circle"), 2300);
    ...
    const handlePointerMove = (e: React.PointerEvent) => {
        ...
        const delta = (startYRef.current - e.clientY) * 1.8;
        startYRef.current = e.clientY;
    ...
    return (
        <div
            ...
            className="relative w-full h-full bg-[#080808] text-white overflow-hidden select-none cursor-grab active:cursor-grabbing"
        >
            {/* Background subtle radial ambient glow */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(200,162,74,0.08),transparent_70%)] pointer-events-none" />
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2 px-4">
                    <motion.h1
                        ...
                        className="text-2xl font-medium tracking-tight text-white/95 md:text-4xl"
                    >
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-xs font-bold tracking-[0.25em] text-[#C8A24A]"
                    >
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#C8A24A]/10 border border-[#C8A24A]/30 mb-3 backdrop-blur-md">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C8A24A] animate-ping" />
                        <span className="text-[10px] uppercase font-mono tracking-widest text-[#C8A24A]">Curated Gallery</span>
                    </div>
                    ...
                    <p className="text-sm md:text-base text-zinc-400 max-w-lg leading-relaxed">
                        ...
                        Scroll or drag through our curated collection of innovations.
                    </p>
                </motion.div>
